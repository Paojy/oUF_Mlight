...
ns.L["fontflag"] = "字體描邊"
ns.L["tenthousand"] = "以萬/千萬計數"
ns.L["alwayshp"] = "總是顯示生命值"
ns.L["alwayshp2"] = "禁用則只在血量不滿時顯示生命值"
ns.L["alwayspp"] = "總是顯示能量值"
ns.L["alwayspp2"] = "禁用則只在能量不滿時顯示能量值"
ns.L["colormode"] = "顔色模式"
...
ns.L["namelength"] = "名字長度"
ns.L["namelength2"] = "團隊框架中的名字最多顯示幾個字?"
...
ns.L["showmisshp"] = "顯示血量"
ns.L["showmisshp2"] = "在生命值低於90%時顯示血量。"
...
ns.L["ctrl-"] = "ctrl"
ns.L["alt-"] = "alt"
ns.L["incorrect spell name"] = "法術名稱不正確"
ns.L["enter a macro"] = "輸入一個巨集"

ns.L["Independent Player Castbar"] = "獨立的玩家施法條"
ns.L["cbheight"] = "施法條高度"
ns.L["cbwidth"] = "施法條寬度"
ns.L["xoffset"] = "水平偏移"
ns.L["yoffset"] = "垂直偏移"
ns.L["Show every tick in a channel spell"] = "引導法術分段"
ns.L["tickcolor"] = "顏色"