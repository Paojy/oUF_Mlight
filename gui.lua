...
sizetext:SetPoint("TOPLEFT", 14, 3-16*30)
sizetext:SetText(L["framesize"])

local heightbox = createeditbox(scrollFrame.Anchor, 15, L["height"], "height", L["height2"])
local widthbox = createeditbox(scrollFrame.Anchor, 16, L["width"], "width", L["width2"])
local widthpetbox = createeditbox(scrollFrame.Anchor, 17, L["widthpet"], "widthpet", L["widthpet2"])
local widthbossbox = createeditbox(scrollFrame.Anchor, 18, L["widthboss"], "widthboss", L["widthboss2"])
local scaleslider = createslider(scrollFrame.Anchor, 19, L["scale"], "scale", 0.5, 3, 0.05, L["scale2"])
local hpheightslider = createslider(scrollFrame.Anchor, 20, L["hpheight"], "hpheight", 0.2, 0.95, 0.05, L["hpheight2"])

local castbartext = scrollFrame.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLarge")
castbartext:SetPoint("TOPLEFT", 16, 3-21*30)
castbartext:SetText(L["castbar"])

local castbarsbu = createcheckbutton(scrollFrame.Anchor, 22, L["enablecastbars"], "castbars", L["enablecastbars2"])
local cbIconsizebox = createeditbox(scrollFrame.Anchor, 23, L["cbIconsize"], "cbIconsize", L["cbIconsize2"])
createDR(castbarsbu, cbIconsizebox)

local auratext = scrollFrame.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLarge")
auratext:SetPoint("TOPLEFT", 16, 3-24*30)
auratext:SetText(L["aura"])

local aurasbu = createcheckbutton(scrollFrame.Anchor, 25, L["enableauras"], "auras", L["enableauras2"])
local aurabordersbu = createcheckbutton(scrollFrame.Anchor, 26, L["auraborders"], "auraborders", L["auraborders2"])
local auraperrowslider = createslider(scrollFrame.Anchor, 27, L["aurasperrow"], "auraperrow", 4, 20, 1, L["aurasperrow2"])
local playerdebuffbu = createcheckbutton(scrollFrame.Anchor, 38, L["enableplayerdebuff"], "playerdebuffenable", L["enableplayerdebuff2"])
local playerdebuffperrowslider = createslider(scrollFrame.Anchor, 29, L["playerdebuffsperrow"], "playerdebuffnum", 4, 20, 1, L["playerdebuffsperrow2"])
local AuraFilterignoreBuffbu = createcheckbutton(scrollFrame.Anchor, 30, L["AuraFilterignoreBuff"], "AuraFilterignoreBuff", L["AuraFilterignoreBuff2"])
local AuraFilterignoreDebuffbu = createcheckbutton(scrollFrame.Anchor, 31, L["AuraFilterignoreDebuff"], "AuraFilterignoreDebuff", L["AuraFilterignoreDebuff2"])
local AuraFiltertext = scrollFrame.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
AuraFiltertext:SetPoint("TOPLEFT", 16, 3-32*30)
...
threatbartext:SetPoint("TOPLEFT", 16, 3-33*30)
threatbartext:SetText(L["threatbar"])

local showthreatbarbu = createcheckbutton(scrollFrame.Anchor, 34, L["showthreatbar"], "showthreatbar", L["showthreatbar2"])
local tbvergradientbu = createcheckbutton(scrollFrame.Anchor, 35, L["tbvergradient"], "tbvergradient", L["tbvergradient2"])
...
bosstext:SetPoint("TOPLEFT", 16, 3-36*30)
bosstext:SetText(L["bossframe"])

local bossframesbu = createcheckbutton(scrollFrame.Anchor, 37, L["bossframes"], "bossframes", L["bossframes2"])
--====================================================--
--[[                 -- Raid --                     ]]--
--====================================================--
